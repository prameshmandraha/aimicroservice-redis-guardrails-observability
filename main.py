...
VALID_KEYS = set(os.getenv("VALID_API_KEYS", "dev-key-001").split(","))  # Load from env in prod
...
async def generate(request: Request, payload: AIRequest, api_key: str = Depends(verify_api_key)):
